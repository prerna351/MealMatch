      ...
      <div className='overflow-x-clip'>
        ...
        <div className='w-full h-screen px-6 md:px-10 flex justify-center'>
            <div className='mt-20 w-full max-w-[1100px] h-screen'>
               ...
               <div className='flex justify-center font-bold text-3xl md:text-5xl pb-20'><h1>View Services in <span className='text-green-500 ml-1'>Popular Cities</span></h1></div>
               <div className='w-full grid grid-cols-3 gap-7 sm:grid-cols-4 md:gap-9 lg:grid-cols-5'>
                ...
                <CityCard image_link={"/cities/Pune.jpg"} city_name={"Pune"}/>
                <CityCard image_link={"/cities/Gurgaon.jpg"} city_name={"Gurgaon"}/>
                <CityCard image_link={"/cities/Bhubaneswar.jpg"} city_name={"Bhubaneswar"}/>
                <CityCard image_link={"/cities/Chennai.jpg"} city_name={"Chennai"}/>
